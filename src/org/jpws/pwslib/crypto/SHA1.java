...
public class SHA1
{
  ...
  /**
   * Partially clears the data.  Use {@link #clear()} to clear more data or
   * {@link #reset()} to start again.
   * <p>!!WARNING!! - This method is PWS specific. Use of it may lead to a 
   * corrupted SHA1 value!
   */
  public void clearContext()
  {
     for ( int ii = 0; ii < m_state.length; ++ii )
     {
        m_state[ii] = 0;
     }
     for ( int ii = 0; ii < m_block.length; ++ii )
     {
        m_block[ii] = 0;
     }
     m_lCount = 0;
 ...
 ///////////////////////////////////////////////////////////////////////////
    ...
    */
	...
	public boolean selfTest()
	{
		...
		try { tester.update(SELFTEST_MESSAGE.getBytes("ASCII")); }
      catch ( Exception e )
      {
         return false;
      }
